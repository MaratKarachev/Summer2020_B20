...
public class Util {
    ...
    public static int minNum(int[] arr) {
        ...
        /*
        1.a method that can find the frequency of characters
    ...
    // inserts an element to the double array

    /*
     Double, Integer, char, Character, String array
     */
    ...
    //combines two array and return it
