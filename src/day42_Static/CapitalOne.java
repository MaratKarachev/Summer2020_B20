...
public class CapitalOne {
    public static void main(String[] args) {
        ...
        developers[3].setInfo("Virginia",'F', 76543L, "Dev", 130000);
        developers[4].setInfo("Akbar", 'M', 5345L, "Dev", 120000);
        ...
        for(Developer each: team1.developers){//each: every single developers in the scrum team
            System.out.println(each.name+ " : "+each.salary);
        }
        System.out.println("================================================");
        ...
        dev1.setInfo("Marat",'M',77777L,"DevOps",160000);
