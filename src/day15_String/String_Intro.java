...
public class String_Intro {
    public static void main(String[] args) {
        ...
        String c1 = "Cybertek"; // String literal ==> String Pool
        String c2 = new String("Cybertek"); // Java heap
        String c3 = new String("Cybertek");
        String c4 = "Cybertek"; // String literal ==> String Pool
        String c5 = "cybertek"; // String pool, different object because of lower case "c"
